...
//shadow_intersect.c
float	shadow_sphere_intersect(t_coord *dot_light, t_sphere *sphere, \
														t_coord *dot_sphere);
float	shadow_plane_intersect(t_coord *dot_light, t_plane *plane, \
															t_coord *dot);

float	shadow_disk_plane_intersect(t_coord *dot_light, t_coord *dot, \
															t_plane *plane);
float	shadow_disc_intersect(t_coord *dot_light, t_coord *dot, \
													t_plane *plane, float r);
void	shadow_get_discr(t_coord *dot_light, t_cylind *cylind, t_coord *dot, \
																t_coef *coef);
float	shadow_pipe_intersect(t_coord *dot_light, t_cylind *cylind, \
																t_coord *dot);
float	shadow_cylindr_intersect(t_coord *dot_light, t_cylind *cylind, \
																t_coord *dot);
